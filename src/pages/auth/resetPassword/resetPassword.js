      ...
      <div className="container-fluid mx-auto col-md-5 mt-5 mb-4 ">
        ...
        <form onSubmit={handleSubmit}>
          <div className="row  custom-table mx-3 my-5" id="CardBackIMg1">
            ...
            <div className='row ms-lg-4 ms-md-0'>
            <div className='col-6'>
              <Link className='btn my-3 px-4 btn border border-danger rounded bg-white  text-black' to="/login">Back to login</Link>
            </div>
            <div className="col-6">
              <Link className='btn my-3 px-4 btn border border-danger rounded bg-white text-black' to="/">Continue as Guest</Link>
            </div>
            </div>
          </div>
        </form>
